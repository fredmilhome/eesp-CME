...
If we started with $x_0 = 10$ for Nelder-Mead and Gradient Descent, it is possible they would have a better shot at finding the same minimum as the other algorithms, but we saw they're very sensible to the initial choice of $x_0$.
...
The block below computes the table with possible hsteps and orders for the central finite difference method, and the numerical derivatives and errors from the analytical derivatives.
